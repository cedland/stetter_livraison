...
import 'WidgetUpdateBulletin/update_bulletin_list.dart';



class UpdateBulletinScreen extends StatefulWidget {
  UpdateBulletinScreen({Key? key}) : super(key: key);
  ...
  @override
  State<UpdateBulletinScreen> createState() => _UpdateBulletinScreenState();
}
class _UpdateBulletinScreenState extends State<UpdateBulletinScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CustomAppBar(title: "MISE A JOUR BULLETIN", function: CustomAppBarFunction.back),
              ...
              children: [
                ...
                Expanded(
                  child: _foundActivity.isNotEmpty
                      ? Column(
                    children: [
                      Expanded(child: UpdateBulletinsList(widget._registeredBulletins, widget._registeredProduits, widget._registeredclients)),
                    ],
                  )
                      : Padding(
