...
import '../../PageBulletin/WidgetsBulletin/WidgetDetailBulletin/ajout_produit_list_bulletin.dart';
import '../../PagesProduit/WidgetsProduit/list_categorie.dart';
import '../../couleurs.dart';
import '../../dimensions_pages.dart';
import 'showCartScreenClient.dart';


class AjoutProduitClient extends StatefulWidget {
  AjoutProduitClient({super.key});

  final List<ProduitMod> _registeredProduits = ProduitMod.produits();

  @override
  State<AjoutProduitClient> createState() => _AjoutProduitClientState();
}

class _AjoutProduitClientState extends State<AjoutProduitClient> {
              ...
              child: IconButton(
                onPressed: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => const ShowCartScreenClient(),
                    ),
                  );
                },
                icon: const Icon(
